...
const ProductionCacaoChart = () => {
  ...
  return (
    <div className="w-full bg-white shadow-lg rounded-xl p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2">
          ...
          <button
            ...
            className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition ml-4 cursor-pointer"
          >
            Exporter en PDF
          </button>
        </div>
      ...
      {!loading && !error && dataFiltrée.length > 0 && (
        <>
          <div id="chart-container" className="h-[400px] w-full bg-white">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart
                data={dataFiltrée}
                margin={{ top: 10, right: 30, left: 20, bottom: 10 }}
